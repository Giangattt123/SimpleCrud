...
const Header = () => {
  return (
    <>
      <div className="w-[90%] h-[50px] my-10 rounded-xl bg-[#2d3748] mx-auto flex justify-between items-center selection:bg-white selection:text-[#0b1623]">
        <a
          href="/"
        ...
        >
          ...
          <p className="indent-2">CRUD APP EXAMPLE</p>
        </a>

        <a
          className="text-white text-2xl mr-5 hover:text-[#d6ba8f] duration-300"
          href="https://github.com/giangattt123/"
          target="_blank"
        >
          <PiGithubLogo />
        </a>
